...
| `npm run validate:workflow` | 离线校验 `.github/workflows/ci.yml`（35 断言：任务/触发/secrets 用法/步骤顺序/版本一致性检查/`--ignore-scripts` 等），改工作流后跑一次 |
